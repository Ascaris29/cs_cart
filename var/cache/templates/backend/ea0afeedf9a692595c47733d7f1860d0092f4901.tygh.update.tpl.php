<?php /* Smarty version Smarty-3.1.21, created on 2022-06-24 16:14:20
         compiled from "/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/profile_fields/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20923909262b5b8ac81dd02-25096973%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea0afeedf9a692595c47733d7f1860d0092f4901' => 
    array (
      0 => '/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/profile_fields/update.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20923909262b5b8ac81dd02-25096973',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b5b8acc11174_16589347',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b5b8acc11174_16589347')) {function content_62b5b8acc11174_16589347($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/function.script.php';
...
&nbsp;/&nbsp;<?php echo $_smarty_tpl->__("required");?>
                ...
                <div class="controls">
                    <input type="hidden"
                        name="field_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_show']->value, ENT_QUOTES, 'UTF-8');?>
]"
...
"
                        id="sw_req_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_required']->value, ENT_QUOTES, 'UTF-8');?>
"
                    ...
                    <input type="hidden"
                        name="field_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_required']->value, ENT_QUOTES, 'UTF-8');?>
]"
                        value="<?php if (($_smarty_tpl->tpl_vars['field']->value['field_name']==="email"&&$_smarty_tpl->tpl_vars['field']->value['is_default']===smarty_modifier_enum("YesNo::YES"))||($_smarty_tpl->tpl_vars['field']->value['field_name']==="company"&&$_smarty_tpl->tpl_vars['field']->value['profile_type']===smarty_modifier_enum("ProfileTypes::CODE_SELLER")&&$_smarty_tpl->tpl_vars['field']->value['is_default']===smarty_modifier_enum("YesNo::YES"))) {
echo htmlspecialchars(smarty_modifier_enum("YesNo::YES"), ENT_QUOTES, 'UTF-8');
} else {
