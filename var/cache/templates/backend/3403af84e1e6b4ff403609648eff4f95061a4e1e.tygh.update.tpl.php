<?php /* Smarty version Smarty-3.1.21, created on 2022-06-24 16:10:43
         compiled from "/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/payments/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:94698635862b5b7d367b203-96693277%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3403af84e1e6b4ff403609648eff4f95061a4e1e' => 
    array (
      0 => '/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/payments/update.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '94698635862b5b7d367b203-96693277',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b5b7d3844d45_45187527',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b5b7d3844d45_45187527')) {function content_62b5b7d3844d45_45187527($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/block.hook.php';
?><?php
...
">
        ...
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"payments:name_post")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"payments:name_post"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>

        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"payments:name_post"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
:</label>
            <div class="controls">
                <?php echo $_smarty_tpl->getSubTemplate ("common/adaptive_object_selection.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('input_name'=>"payment_data[tax_ids]",'input_id'=>"elm_payment_taxes",'item_ids'=>$_smarty_tpl->tpl_vars['payment']->value['tax_ids'],'items'=>$_smarty_tpl->tpl_vars['taxes']->value,'id_field'=>"tax_id",'name_field'=>"tax",'type'=>"taxes",'class_prefix'=>"taxes",'close_on_select'=>"false",'list_mode'=>false), 0);?>
