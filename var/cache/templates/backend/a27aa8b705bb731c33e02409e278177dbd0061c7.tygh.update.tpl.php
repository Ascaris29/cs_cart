<?php /* Smarty version Smarty-3.1.21, created on 2022-06-26 23:51:06
         compiled from "/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/statuses/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:171788558262b8c6ba401750-38714122%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a27aa8b705bb731c33e02409e278177dbd0061c7' => 
    array (
      0 => '/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/statuses/update.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '171788558262b8c6ba401750-38714122',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b8c6ba533cd1_95112657',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b8c6ba533cd1_95112657')) {function content_62b8c6ba533cd1_95112657($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/modifier.enum.php';
if (!is_callable('smarty_block_hook')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/block.hook.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('general','name','status','email_subject','email_header','decrease'));
?>
...
" class="control-label<?php if ($_smarty_tpl->tpl_vars['data']->value['type']=="color") {?> cm-color<?php }?>">
                <?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['data']->value['label']);?>
            ...
            <div class="controls">
                <?php if ($_smarty_tpl->tpl_vars['id']->value) {?>
                    ...
                    <?php $_smarty_tpl->tpl_vars['is_editable'] = new Smarty_variable($_smarty_tpl->tpl_vars['status_data']->value["params"]["is_editable_".((string)$_smarty_tpl->tpl_vars['name']->value)], null, 0);?>
                <?php } else { ?>
                ...
                <?php } elseif ($_smarty_tpl->tpl_vars['data']->value['type']=="select") {?>
                    <?php if ($_smarty_tpl->tpl_vars['is_editable']->value===smarty_modifier_enum("YesNo::NO")) {?>
                        <input type="hidden" name="status_data[params][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status_data']->value["params"][$_smarty_tpl->tpl_vars['name']->value], ENT_QUOTES, 'UTF-8');?>
">
                        <p class="shift-top"><?php echo $_smarty_tpl->__("decrease");?>
</p>
                        <p class="muted description"><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['status_data']->value["params"][((string)$_smarty_tpl->tpl_vars['name']->value)."_info"]);?>
</p>
                    <?php } else { ?>
