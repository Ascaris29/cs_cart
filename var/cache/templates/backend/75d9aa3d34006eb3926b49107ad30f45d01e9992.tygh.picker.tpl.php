<?php /* Smarty version Smarty-3.1.21, created on 2022-06-24 17:47:59
         compiled from "/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/addons/banners/pickers/banners/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:195464232662b5ce9fc09a84-45641753%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75d9aa3d34006eb3926b49107ad30f45d01e9992' => 
    array (
      0 => '/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/addons/banners/pickers/banners/picker.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '195464232662b5ce9fc09a84-45641753',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b5ce9fe15ba6_86400398',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b5ce9fe15ba6_86400398')) {function content_62b5ce9fe15ba6_86400398($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/Applications/MAMP/htdocs/cs_cart2/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
_no_item"<?php if ($_smarty_tpl->tpl_vars['item_ids']->value) {?> class="hidden"<?php }?>>
        <tr>
            <td colspan="<?php if ($_smarty_tpl->tpl_vars['positions']->value) {?>3<?php } else { ?>2<?php }?>" data-th="&nbsp;"><p class="no-items"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['no_item_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("no_items") : $tmp), ENT_QUOTES, 'UTF-8');?>
</p></td>
        </tr>
        </tbody>
        </table>
