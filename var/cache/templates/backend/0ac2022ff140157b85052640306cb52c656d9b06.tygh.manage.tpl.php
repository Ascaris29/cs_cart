<?php /* Smarty version Smarty-3.1.21, created on 2022-06-24 15:26:32
         compiled from "/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/product_features/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:174639965262b5ad78286581-79445543%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ac2022ff140157b85052640306cb52c656d9b06' => 
    array (
      0 => '/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/product_features/manage.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '174639965262b5ad78286581-79445543',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b5ad787b31e2_06356702',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b5ad787b31e2_06356702')) {function content_62b5ad787b31e2_06356702($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_modifier_to_json')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/modifier.to_json.php';
if (!is_callable('smarty_block_hook')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/block.hook.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('name_short','internal_feature_name_tooltip','storefront_name_short','storefront_name','product_features_are_not_selectable_for_context_menu','feature','view','group','view','categories','edit','delete','view','status','no_data','new_feature','new_feature','features'));
?>
                        ...
                        <table width="100%" class="table table-middle table--relative table-responsive table--overflow-hidden">
                            ...
                            <tr>
                                <th class="left mobile-hide table__check-items-column">
                                    <?php echo $_smarty_tpl->getSubTemplate ("common/check_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('check_statuses'=>$_smarty_tpl->tpl_vars['product_feature_statuses']->value,'is_check_disabled'=>!$_smarty_tpl->tpl_vars['has_available_features']->value,'meta'=>"table__check-items"), 0);?>
                                ...
                                <th width="29%">
                                    <div class="th-text-overflow-wrapper">
                                        <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"name",'text'=>$_smarty_tpl->__("name_short")), 0);?>

                                        <?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("internal_feature_name_tooltip")), 0);?>

                                        <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"storefront_name",'text'=>$_smarty_tpl->__("storefront_name_short"),'title'=>$_smarty_tpl->__("storefront_name")), 0);?>

                                    </div>
                                </th>
                                <th width="20%">
                                    <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"group"), 0);?>

                                </th>
                                <th class="mobile-hide" width="33%">
                                    <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"categories"), 0);?>
