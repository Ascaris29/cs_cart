<?php /* Smarty version Smarty-3.1.21, created on 2022-06-23 15:51:57
         compiled from "/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/product_options/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:93733994162b461edf24187-87853781%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '98b5deb13fd5ab573c88d634e8471eb925c7d09d' => 
    array (
      0 => '/Applications/MAMP/htdocs/cs_cart2/design/backend/templates/views/product_options/manage.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '93733994162b461edf24187-87853781',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b461ee183ae3_46882261',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b461ee183ae3_46882261')) {function content_62b461ee183ae3_46882261($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/function.script.php';
                                    ...
                                    <thead
                                        ...
                                        <tr>
                                            <th class="left mobile-hide table__check-items-column">
                                                <?php echo $_smarty_tpl->getSubTemplate ("common/check_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('check_statuses'=>$_smarty_tpl->tpl_vars['has_permissions']->value ? ($_smarty_tpl->tpl_vars['product_option_statuses']->value) : '','is_check_disabled'=>!$_smarty_tpl->tpl_vars['has_available_options']->value,'meta'=>"table__check-items"), 0);?>
                                            ...
                                            <th>
                                                <div class="th-text-overflow-wrapper">
                                                    <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"internal_option_name",'text'=>$_smarty_tpl->__("name")), 0);?>

                                                    <?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("internal_option_name_tooltip")), 0);?>

                                                    <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"option_name",'text'=>$_smarty_tpl->__("storefront_name")), 0);?>
...
$_tmp27=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['details'] = new Smarty_variable("(".$_tmp27.")", null, 0);?>
                                        ...
                                        <?php if (fn_allowed_for("MULTIVENDOR")) {?>
                                            <?php if ($_smarty_tpl->tpl_vars['allow_save']->value&&($_smarty_tpl->tpl_vars['product_option']->value['company_id']||!$_smarty_tpl->tpl_vars['runtime']->value['company_id'])) {?>
                                                ...
                                                <?php ob_start();
if ($_smarty_tpl->tpl_vars['product_option']->value['company_id']&&!$_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?><?php echo "cm-vendor-product-option";?><?php }
$_tmp28=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['additional_class'] = new Smarty_variable("cm-no-hide-input cm-longtap-target ".$_tmp28, null, 0);?>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php ob_start();
if ($_smarty_tpl->tpl_vars['product_option']->value['company_id']&&!$_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?><?php echo "cm-vendor-product-option";?><?php }
$_tmp29=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['additional_class'] = new Smarty_variable("cm-longtap-target ".$_tmp29, null, 0);?>
