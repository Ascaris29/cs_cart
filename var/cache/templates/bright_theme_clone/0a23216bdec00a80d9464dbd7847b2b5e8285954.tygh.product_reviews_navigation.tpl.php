<?php /* Smarty version Smarty-3.1.21, created on 2022-06-23 15:52:16
         compiled from "/Applications/MAMP/htdocs/cs_cart2/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_navigation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:119752648462b4620001eee6-06171054%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a23216bdec00a80d9464dbd7847b2b5e8285954' => 
    array (
      0 => '/Applications/MAMP/htdocs/cs_cart2/design/themes/responsive/templates/addons/product_reviews/views/product_reviews/components/product_reviews_navigation.tpl',
      1 => 1655987802,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '119752648462b4620001eee6-06171054',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b4620009f974_15769888',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b4620009f974_15769888')) {function content_62b4620009f974_15769888($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/Applications/MAMP/htdocs/cs_cart2/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
$_tmp36=ob_get_clean();?><?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp36."&selected_section=product_reviews")), ENT_QUOTES, 'UTF-8');?>
"
    ...
    <nav class="ty-product-review-reviews-navigation">
        ...
        <label class="ty-product-review-reviews-navigation__filter <?php if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?>ty-product-review-reviews-navigation__filter--active<?php }?>">
            ...
            <a id="product_review_with_images_link"
                href="<?php ob_start();
if ($_smarty_tpl->tpl_vars['product_reviews_with_images']->value) {?><?php echo "0";?><?php } else { ?><?php echo "1";?><?php }
$_tmp37=ob_get_clean();?><?php echo htmlspecialchars(fn_url(fn_link_attach($_smarty_tpl->tpl_vars['curl']->value,"with_images=".$_tmp37."&selected_section=product_reviews")), ENT_QUOTES, 'UTF-8');?>
"
                class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                data-ca-target-id="pagination_contents_comments_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product_id']->value, ENT_QUOTES, 'UTF-8');?>
"
